...
retrain_params=struct('a_minus_r', 0.03, 'a_plus_r', 0.05, 'a_minus_p', 0.07, 'a_plus_p', 0.01,...
                     'tao_minus_r',40, 'tao_plus_r',20, 'tao_minus_p', 80, 'tao_plus_p', 10,'retrain_iter',1200);
%-------------------------------------根据输入参数创建网络SDNN_net----------------------------------------------------
%网络结构初始化
...
%设置权值
 weights_path_list='weights_retrain_800.mat';    %权值读取路径
...
save("training_correct_rate_retrain_800.mat","training_correct_rate");
save("learning_correct_rate_rate_retrain_800.mat","learning_correct_rate");
save("testing_correct_rate_rate_retrain_800.mat","testing_correct_rate");
...
SVM_learning_correct_retrain_rate_400=correct_rate(label_learn,result_learn);
SVM_training_correct_retrain_rate_400=correct_rate(label_train,result_train);
SVM_testing_correct_retrain_rate_400=correct_rate(label_test,result_test);
