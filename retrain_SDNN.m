...
n=0;
 ...
 for i=1:max_iter  %max_iter 
     ...
     %Ȩֵ�洢--------------------------------------------
     if i==100
         save('weights_retrain_100_57.mat','weights');
     elseif i==200
         save('weights_retrain_200_57.mat','weights');
     elseif i==300
         save('weights_retrain_300_57.mat','weights');
     elseif i==400
         save('weights_retrain_400_57.mat','weights');
     elseif i==500
         save('weights_retrain_500_57.mat','weights');
     elseif i==600
         save('weights_retrain_600_57.mat','weights');
     elseif i==700
         save('weights_retrain_700_57.mat','weights');
     elseif i==800
         save('weights_retrain_800_57.mat','weights');
     elseif i==900
         save('weights_retrain_900_57.mat','weights');
     elseif i==1000
         save('weights_retrain_1000_57.mat','weights');
     elseif i==1100
         save('weights_retrain_1100_57.mat','weights');
     elseif i==1200
         save('weights_retrain_1200_57.mat','weights');
     elseif i==1300
         save('weights_retrain_1300_57.mat','weights'); 
     elseif i==1400
         save('weights_retrain_1400_57.mat','weights');
     elseif i==1500
         save('weights_retrain_1500_57.mat','weights');
