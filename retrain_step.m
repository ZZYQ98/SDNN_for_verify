...
for t=1:total_time      %按照时间顺序使得网络进行学习 经过这么长的时间，才能保证所有输入脉冲信息传递过网络
 ...
 %获得进行STDP的矩阵的位置
  ...
  [weights] = STDP_label_5_5(layers,learning_layer,STDP_index,weights,network_struct,deta_STDP_minus_r ,deta_STDP_plus_r,deta_STDP_minus_p,delta_STDP_plus_p,label);
